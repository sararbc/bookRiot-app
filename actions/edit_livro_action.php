<?php
  ...
  if(!empty($_POST['Confirmar'])){
    ...
    // Msg de erro na variável de sessão: ESTÁ ERRADO 
    if(!$dados_validos){
      ...
      header("Location: ../pages/admin_UpdateLivro.php?livro_id=".$livro_id);
    }
    else{
      updateLivro($titulo, $categoria_id, $preco, $editora, $autor, $sinopse, $tempo_entrega, $fileName, $livro_id);
      header('Location: ../pages/admin_livros.php');
    }
  }
?>
